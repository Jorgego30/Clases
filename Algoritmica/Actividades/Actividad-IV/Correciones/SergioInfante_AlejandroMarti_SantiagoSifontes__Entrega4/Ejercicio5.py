...
# Primer nivel
Arb.insertarIzquierdo('*')
Arb.insertarDerecho('-')

# Segundo nivel
Arb.hijoIzquierdo.insertarIzquierdo(2)
Arb.hijoIzquierdo.insertarDerecho(4)
Arb.hijoDerecho.insertarIzquierdo(7)
Arb.hijoDerecho.insertarDerecho(3)



print(imprimirExpresion(Arb))