...
class Laberinto:
    def __init__(self,nombreArchivoLaberinto):
        ...
        self.wn.setworldcoordinates(-(columnasEnLaberinto-1)/2-.5,\
            -(filasEnLaberinto-1)/2-.5,(columnasEnLaberinto-1)/2+.5,\
