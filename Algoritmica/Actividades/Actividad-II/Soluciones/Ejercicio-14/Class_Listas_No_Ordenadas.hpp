...
public:
    ...
    int size(){
        return tamaño; // Devuelve el tamaño almacenado en la cabeza de la lista
    }

    // Método para incrementar el tamaño cuando se agrega un nodo
    void aumentarSize()
    {
        tamaño++;
    }

    // Método para decrementar el tamaño cuando se elimina un nodo
    void reducirSize()
    {
        tamaño--;
    }
