...
def robot_structure():
	...
	axis2 = np.array([0, -1, 0]) # Eje de rotación de la segunda articulación
	axis3 = np.array([1, 0, 0]) # Eje de rotación de la tercera articulación
	...
	q3 = np.array([0, 0, -1]) # Posición de la tercera articulación
