...
# Calculamos el rango de la matriz Jacobiana en la posición 0
rango_J = np.linalg.matrix_rank(Jp0)

print("Matriz Jacobiana en posición 0:")
print(Jp0)
print("Rango de la matriz Jacobiana en posición 0:", rango_J)
